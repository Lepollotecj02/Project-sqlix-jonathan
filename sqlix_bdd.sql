...
--
-- Host: localhost    Database: sqlix_bdd
-- ------------------------------------------------------
...
CREATE TABLE `absorber` (
  ...
  CONSTRAINT `absorber_ibfk_2` FOREIGN KEY (`quantite`) REFERENCES `potion` (`num_potion`)
...
INSERT INTO `absorber` VALUES (1,'2052-04-03 00:00:00',7,1),(1,'2052-08-18 00:00:00',16,1),(2,'2052-06-06 00:00:00',7,1),(3,'2052-02-20 00:00:00',7,1),(3,'2052-10-23 00:00:00',13,1),(5,'2052-05-10 00:00:00',2,1),(5,'2052-07-17 00:00:00',7,1),(1,'2052-02-20 00:00:00',2,2),(1,'2052-02-20 00:00:00',8,2),(1,'2052-04-03 00:00:00',15,2),(1,'2052-06-06 00:00:00',13,2),(1,'2052-11-26 00:00:00',10,2),(2,'2052-11-26 00:00:00',8,2),(3,'2052-08-18 00:00:00',10,2),(4,'2052-05-05 00:00:00',15,2),(4,'2052-08-18 00:00:00',7,2),(4,'2052-09-20 00:00:00',1,2),(5,'2052-06-07 00:00:00',1,2),(5,'2052-11-26 00:00:00',13,2),(5,'2052-11-26 00:00:00',16,2),(1,'2052-02-18 00:00:00',7,3),(1,'2052-08-18 00:00:00',8,3),(2,'2052-07-18 00:00:00',7,3),(4,'2052-10-23 00:00:00',13,3),(2,'2052-02-18 00:00:00',12,4),(2,'2052-10-23 00:00:00',7,4),(3,'2052-04-03 00:00:00',10,4),(3,'2052-06-06 00:00:00',8,4),(5,'2052-05-10 00:00:00',1,4),(2,'2052-04-03 00:00:00',13,5),(3,'2052-09-20 00:00:00',7,5);
...
CREATE TABLE `fabriquer` (
  ...
  CONSTRAINT `fabriquer_ibfk_2` FOREIGN KEY (`num_habitant`) REFERENCES `habitant` (`num_habitant`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-02-23 17:13:22
